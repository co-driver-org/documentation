            ...
            <header className={styles.heroBanner}>
                <div className="container">
                    ...
                    <div className={styles.buttons}>
                        <a className="button button--primary button--lg" href="/guides/api-management">
                            Get Started
                        </a>
                        <a className="button button--secondary button--lg" href="/api-reference/authentication">
                            API Reference
                        </a>
                    </div>
                </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col col--4">
                                ...
                                <a href="/guides/api-management" className="button button--outline button--primary">
                                    Read Guides
                                </a>
                            </div>
                            <div className="col col--4">
                                ...
                                <a href="/quickstarts/getting-started" className="button button--outline button--primary">
                                    Start Now
                                </a>
                            </div>
                            <div className="col col--4">
                                ...
                                <a href="/api-reference/authentication" className="button button--outline button--primary">
                                    View API Docs
                                </a>
                            </div>
                        </div>
